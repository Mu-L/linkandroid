...
### 优化
- 优化：无线设备设置中的端口变化提示支持多语言
- 优化：二维码无线配对支持按设备名称匹配连接服务，并在关闭或重新生成二维码时取消旧扫描任务
...
### 修复
- 修复：二维码配对成功后错误回退到固定 5555 端口导致动态端口设备连接失败
...
- 优化：spawnShell 增加 maxLogLines 参数，限制 stdout/stderr 日志缓冲区大小，避免内存无限增长
- 优化：mirror 投屏日志只保留最近 200 行，避免结束后重复打印全部日志
- 优化：投屏息屏/亮屏改用 scrcpy 控制协议实现，避免触发锁屏
- 优化：投屏控制面板初始化时自动查询设备真实屏幕状态，确保图标与状态一致
